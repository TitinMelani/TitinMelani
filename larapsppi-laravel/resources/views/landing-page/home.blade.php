 ...
 <!-- Awal Visi Misi Dan Latar Belakang-->
    <div class="container kurfas">
        <div class="kurikulum-1">
            ...
            <p class="kurikulum-tag">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat reprehenderit iste voluptatibus, ut a odit perspiciatis nostrum excepturi quasi qui soluta amet quo! Earum sequi sapiente enim et, rerum ea.</p>
    ...
    <div class="container">
        <div class="berita">
            <h5 class="berita-title">Berita dan Acara</h5>
            ...
            <div class="container-row">
                <div class="berita-konten-wrap">
                    ...
                    <div class="berita-konten">
                        ...
                        <a href="/berita">
                        <p class="berita-konten-title">Tahun ini
                        </p>
    ...
    <div class="container">
        <div class="prestasi">
            <h5 class="prestasi-title">Prestasi</h5>
            <p class="prestasi-tag">Apa saja sih fasilitas yang disediakan di Program Studi Program Profesi Insinyur ini? Ayoo cek dan temukan fasilitasnya</p>
